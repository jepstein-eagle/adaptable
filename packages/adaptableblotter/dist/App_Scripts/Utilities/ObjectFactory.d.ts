...
export declare module ObjectFactory {
    ...
    function CreateEmptyAlert(): IAdaptableAlert;
    ...
    function CreateEmptyReminder(): IReminder;
    function CreateEmptyAutoExport(): IAutoExport;
    function CreateEmptySchedule(): ISchedule;
