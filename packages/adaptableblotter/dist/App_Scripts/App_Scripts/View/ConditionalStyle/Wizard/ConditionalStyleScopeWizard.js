            ...
            React.createElement(react_bootstrap_1.Panel, { header: "Select Where the Conditional Style is Applied", bsStyle: "primary" },
                ...
                ArrayExtensions_1.ArrayExtensions.IsNotNullOrEmpty(this.props.ColumnCategories) &&
                    React.createElement(react_bootstrap_1.Col, { xs: 12, className: "ab_large_margin" },
                        ...
                        " ",
                        ' ',
                        React.createElement(AdaptablePopover_1.AdaptablePopover, { cssClassName: cssClassName, headerText: "Conditional Style: Column Categorys", bodyText: ["Pick the Column Category from the list below to apply the conditional style to all Column Categorys."], MessageType: Enums_1.MessageType.Info })),
