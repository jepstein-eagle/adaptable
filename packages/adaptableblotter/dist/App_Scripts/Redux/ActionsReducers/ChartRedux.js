...
exports.CHART_SHOW_CHART = 'CHART_SHOW_CHART';
exports.CHART_HIDE_CHART = 'CHART_HIDE_CHART';
...
exports.ChartShowChart = () => ({
    type: exports.CHART_SHOW_CHART
});
exports.ChartHideChart = () => ({
    type: exports.CHART_HIDE_CHART,
});
...
exports.ChartReducer = (state = initialChartState, action) => {
    ...
    switch (action.type) {
        ...
        case exports.CHART_DEFINITION_DELETE:
            ...
            return Object.assign({}, state, { ChartDefinitions: chartDefinitions });
        case exports.CHART_SHOW_CHART:
            return Object.assign({}, state, { IsChartVisible: true });
        case exports.CHART_HIDE_CHART:
