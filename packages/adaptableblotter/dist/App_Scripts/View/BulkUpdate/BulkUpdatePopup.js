                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement(react_bootstrap_1.Row, null,
                                    React.createElement(react_bootstrap_1.Col, { xs: 9 }, this.state.useSelector ?
                                        React.createElement(ColumnValueSelector_1.ColumnValueSelector, { cssClassName: cssClassName, SelectedColumnValue: this.props.BulkUpdateValue, SelectedColumn: col, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, onColumnValueChange: columns => this.onColumnValueSelectedChanged(columns), AllowNew: false })
                                        :
                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement(react_bootstrap_1.Row, null,
                                    React.createElement(react_bootstrap_1.Col, { xs: 8 },
                                        React.createElement(ColumnValueSelector_1.ColumnValueSelector, { cssClassName: cssClassName, SelectedColumnValue: this.props.BulkUpdateValue, SelectedColumn: col, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, onColumnValueChange: columns => this.onColumnValueSelectedChanged(columns) })),
