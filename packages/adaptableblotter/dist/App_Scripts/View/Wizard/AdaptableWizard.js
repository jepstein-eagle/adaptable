...
class AdaptableWizard extends React.Component {
    ...
    render() {
        ...
        let wizardStepNames = ArrayExtensions_1.ArrayExtensions.RetrieveDistinct(this.props.Steps.map(x => { return x.StepName; }));
            ...
            React.createElement("div", { className: cssClassName + StyleConstants.WIZARD_BASE },
                React.createElement(react_bootstrap_1.Modal.Header, { closeButton: true, className: cssClassName + StyleConstants.WIZARD_HEADER },
                    React.createElement(react_bootstrap_1.Modal.Title, null,
                        React.createElement(WizardLegend_1.WizardLegend, { StepNames: wizardStepNames, ActiveStepName: this.stepName, FriendlyName: this.props.FriendlyName, CanShowAllSteps: this.canFinishWizard(), onStepButtonClicked: (s) => this.onStepButtonClicked(s) }))),
