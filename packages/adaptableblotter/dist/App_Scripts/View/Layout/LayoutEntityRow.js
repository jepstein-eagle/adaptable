...
class LayoutEntityRow extends React.Component {
    render() {
        ...
        let buttons = React.createElement(EntityListActionButtons_1.EntityListActionButtons, { cssClassName: this.props.cssClassName, ConfirmDeleteAction: this.props.onDeleteConfirm, showShare: this.props.TeamSharingActivated, editClick: () => this.props.onEdit(this.props.Index, layout), shareClick: () => this.props.onShare(), overrideDisableEdit: false, overrideDisableDelete: layout.Name == GeneralConstants_1.DEFAULT_LAYOUT, ConfigEntity: layout, EntityName: StrategyNames.LayoutStrategyName });
