...
class LayoutEntityRow extends React.Component {
    render() {
        ...
        colItems[0].Content = React.createElement(EntityRowItem_1.EntityRowItem, { Content: React.createElement(react_bootstrap_1.Radio, { style: { padding: "0px", margin: "0px" }, onChange: () => this.props.onSelect(layout), checked: this.props.IsCurrentLayout }) });
        colItems[1].Content = React.createElement(EntityRowItem_1.EntityRowItem, { Content: layout.Name });
        colItems[2].Content = React.createElement(EntityRowItem_1.EntityRowItem, { Content: LayoutHelper_1.LayoutHelper.getLayoutDescription(layout, this.props.Columns) });
