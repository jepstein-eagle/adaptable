...
class LayoutPopupComponent extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: cssClassName },
            React.createElement(PanelWithButton_1.PanelWithButton, { cssClassName: cssClassName, bsStyle: "primary", headerText: StrategyNames.LayoutStrategyName, infoBody: infoBody, button: newSearchButton, glyphicon: StrategyGlyphs.LayoutGlyph, className: "ab_main_popup" },
                LayoutRows.length > 0 &&
                ...
                this.state.EditedAdaptableBlotterObject != null &&
                    React.createElement(LayoutWizard_1.LayoutWizard, { cssClassName: cssWizardClassName, EditedAdaptableBlotterObject: this.state.EditedAdaptableBlotterObject, ConfigEntities: this.props.Layouts, BlotterOptions: this.props.BlotterOptions, BlotterApi: this.props.BlotterApi, ModalContainer: this.props.ModalContainer, Columns: this.props.Columns, UserFilters: this.props.UserFilters, SystemFilters: this.props.SystemFilters, GridSorts: this.props.GridSorts, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, WizardStartIndex: this.state.WizardStartIndex, onCloseWizard: () => this.onCloseWizard(), onFinishWizard: () => this.onFinishWizard(), canFinishWizard: () => this.canFinishWizard() })));
    }
    onNew() {
