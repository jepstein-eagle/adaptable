...
class AdaptableBlotterView extends React.Component {
    render() {
        return (React.createElement("div", { className: StyleConstants.AB_STYLE + StyleConstants.BASE },
            ...
            React.createElement(AdaptableBlotterPopupConfirmation_1.AdaptableBlotterPopupConfirmation, { Header: this.props.PopupState.ConfirmationPopup.Header, Msg: this.props.PopupState.ConfirmationPopup.Msg, ShowPopup: this.props.PopupState.ConfirmationPopup.ShowConfirmationPopup, CancelButtonText: this.props.PopupState.ConfirmationPopup.CancelButtonText, ConfirmButtonText: this.props.PopupState.ConfirmationPopup.ConfirmButtonText, onCancel: this.props.onCancelConfirmationPopup, onConfirm: this.props.onConfirmConfirmationPopup, ShowCommentBox: this.props.PopupState.ConfirmationPopup.ShowCommentBox, MessageType: this.props.PopupState.ConfirmationPopup.MessageType, AdaptableBlotter: this.props.Blotter }),
