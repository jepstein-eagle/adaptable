...
class CustomSortValuesWizard extends React.Component {
    ...
    render() {
        ...
        let infoBody = ["Create a custom sort for the '" + columnId + "' column by moving items to the 'Custom Sort Order' listbox.", React.createElement("br", null), React.createElement("br", null), "Use the buttons on the right of the box to order items in the list as required.", React.createElement("br", null), React.createElement("br", null), "The new sort will consist first of the items in the 'Custom Sort Order' listbox; all other column values will then sort alphabetically."];
        let cssClassName = this.props.cssClassName + "-values";
        return React.createElement("div", { className: cssClassName },
            React.createElement(PanelWithInfo_1.PanelWithInfo, { cssClassName: cssClassName, header: "Sort Order for: " + columnId, bsStyle: "primary", infoBody: infoBody },
