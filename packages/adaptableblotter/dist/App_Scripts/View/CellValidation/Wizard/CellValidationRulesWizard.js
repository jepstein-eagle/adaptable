            ...
            React.createElement(react_bootstrap_1.Panel, { header: validationRuleHeader, bsStyle: "primary" },
                React.createElement(AdaptableBlotterForm_1.AdaptableBlotterForm, null,
                    ...
                    React.createElement(react_bootstrap_1.Col, { xs: 12, className: "ab_large_margin" },
                        ...
                        ' ',
                        React.createElement(AdaptablePopover_1.AdaptablePopover, { cssClassName: cssClassName, headerText: "Validation Rule: No Edits Allowed", bodyText: ["Any edit is invalid - effectively makes the column read-only."] })),
                    React.createElement(react_bootstrap_1.Col, { xs: 12, className: "ab_large_margin" },
                        ...
                        ' ',
                        React.createElement(AdaptablePopover_1.AdaptablePopover, { cssClassName: cssClassName, headerText: "Validation Rule: Custom", bodyText: ["Disallow edits that match the rule defined in the dropdown below."] }))),
