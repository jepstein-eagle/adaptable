            ...
            React.createElement(react_bootstrap_1.Panel, { header: "Cell Validation Query", bsStyle: "primary" },
                React.createElement(AdaptableBlotterForm_1.AdaptableBlotterForm, { inline: true },
                    ...
                    React.createElement(react_bootstrap_1.Col, { xs: 12 },
                        ...
                        ' ',
                        React.createElement(AdaptablePopover_1.AdaptablePopover, { cssClassName: cssClassName, headerText: "Validation Rule: Query", bodyText: ["Create a query (in next step) which will stipulate other cell values required for the Rule."] })))));
    }
