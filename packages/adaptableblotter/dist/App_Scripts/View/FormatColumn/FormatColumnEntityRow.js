...
class FormatColumnEntityRow extends React.Component {
    render() {
        ...
        colItems[2].Content = React.createElement(EntityListActionButtons_1.EntityListActionButtons, { cssClassName: this.props.cssClassName, editClick: () => this.props.onEdit(this.props.Index, formatColumn), showShare: this.props.TeamSharingActivated, shareClick: () => this.props.onShare(), ConfirmDeleteAction: this.props.onDeleteConfirm, EntityName: StrategyConstantsFormatColumnStrategyName });
