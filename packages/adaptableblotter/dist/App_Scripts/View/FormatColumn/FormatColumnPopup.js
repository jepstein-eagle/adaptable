        ...
        return React.createElement("div", { className: cssClassName },
            React.createElement(PanelWithButton_1.PanelWithButton, { cssClassName: cssClassName, headerText: StrategyNames.FormatColumnStrategyName, button: newButton, bsStyle: "primary", className: "ab_main_popup", glyphicon: StrategyGlyphs.FormatColumnGlyph, infoBody: infoBody },
                ...
                this.state.EditedAdaptableBlotterObject != null &&
                    React.createElement(FormatColumnWizard_1.FormatColumnWizard, { cssClassName: cssWizardClassName, EditedAdaptableBlotterObject: this.state.EditedAdaptableBlotterObject, ModalContainer: this.props.ModalContainer, ColorPalette: this.props.ColorPalette, BlotterOptions: this.props.BlotterOptions, BlotterApi: this.props.BlotterApi, StyleClassNames: this.props.StyleClassNames, UserFilters: this.props.UserFilters, SystemFilters: this.props.SystemFilters, Columns: this.props.Columns, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, ConfigEntities: this.props.FormatColumns, WizardStartIndex: this.state.WizardStartIndex, onCloseWizard: () => this.onCloseWizard(), onFinishWizard: () => this.onFinishWizard(), canFinishWizard: () => this.canFinishWizard() })));
    }
    onNew() {
