...
class FreeTextColumnSummaryComponent extends React.Component {
    ...
    render() {
        ...
        if (!noFreeTextColumn) {
            ...
            FreeTextColumnRow = React.createElement(StrategyDetail_1.StrategyDetail, { key: StrategyConstants.FreeTextColumnStrategyName, cssClassName: this.props.cssClassName, Item1: React.createElement(StrategyProfile_1.StrategyProfile, { cssClassName: this.props.cssClassName, StrategyId: StrategyConstants.FreeTextColumnStrategyId }), Item2: description, ConfigEnity: freeTextColumn, showShare: this.props.TeamSharingActivated, EntityType: StrategyConstants.FreeTextColumnStrategyName, onEdit: () => this.onEdit(index, freeTextColumn), onShare: () => this.props.onShare(freeTextColumn), onDelete: FreeTextColumnRedux.FreeTextColumnDelete(freeTextColumn), showBold: true });
        }
