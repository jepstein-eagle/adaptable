...
class PercentBarEntityRow extends React.Component {
    render() {
        ...
        colItems[1].Content = React.createElement(react_bootstrap_1.FormControl, { type: "number", placeholder: "Min Value", onChange: (e) => this.onMinimumValueChanged(e), value: PercentBar.MinValue });
        colItems[2].Content = React.createElement(react_bootstrap_1.FormControl, { type: "number", placeholder: "Max Value", onChange: (e) => this.onMaximumValueChanged(e), value: PercentBar.MaxValue });
