                    ...
                    React.createElement(react_bootstrap_1.Panel, { header: "Quick Search Options", eventKey: "1", bsStyle: "info" },
                        React.createElement(react_bootstrap_1.FormGroup, { controlId: "formInlineSearchDisplay" },
                            ...
                            React.createElement(react_bootstrap_1.Col, { xs: 1 },
                                React.createElement(AdaptablePopover_1.AdaptablePopover, { cssClassName: cssClassName, headerText: "Quick Search: Behaviour", bodyText: [React.createElement("b", null, "Highlight Cells Only:"), " Changes back colour of cells matching search text", React.createElement("br", null), React.createElement("br", null), React.createElement("b", null, "Show Matching Rows Only:"), " Only shows rows containing cells matching search text", React.createElement("br", null), React.createElement("br", null), React.createElement("b", null, "Highlight Cells and Show Matching Rows:"), " Only shows rows containing cells (which are also coloured) matching search text"] }))),
