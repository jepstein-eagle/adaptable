    ...
    render() {
        ...
        return React.createElement("div", { className: this.props.cssClassName },
            React.createElement(AdaptableWizard_1.AdaptableWizard, { FriendlyName: StrategyConstants.ChartStrategyName, StepNames: stepNames, ModalContainer: this.props.ModalContainer, cssClassName: this.props.cssClassName, Steps: [
                    ...
                    React.createElement(ChartAdditionalColumnWizard_1.ChartAdditionalColumnWizard, { cssClassName: this.props.cssClassName, StepName: stepNames[2], ChartDefinitions: Charts, Columns: this.props.Columns, Blotter: this.props.Blotter }),
                    React.createElement(ChartSettingsWizard_1.ChartSettingsWizard, { cssClassName: this.props.cssClassName, StepName: stepNames[3], ChartDefinitions: Charts }),
