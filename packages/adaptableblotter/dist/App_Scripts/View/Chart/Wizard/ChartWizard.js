    ...
    render() {
        ...
        return React.createElement("div", { className: this.props.cssClassName },
            React.createElement(AdaptableWizard_1.AdaptableWizard, { FriendlyName: StrategyNames.ChartStrategyName, StepNames: stepNames, ModalContainer: this.props.ModalContainer, cssClassName: this.props.cssClassName, Steps: [
                    ...
                    React.createElement(ChartXAxisWizard_1.ChartXAxisWizard, { cssClassName: this.props.cssClassName, StepName: stepNames[2], ChartDefinitions: Charts, Columns: this.props.Columns, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList }),
                    React.createElement(ChartAdditionalColumnWizard_1.ChartAdditionalColumnWizard, { cssClassName: this.props.cssClassName, StepName: stepNames[3], ChartDefinitions: Charts, Columns: this.props.Columns, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList }),
