...
class ChartEntityRow extends React.Component {
    render() {
        ...
        colItems[3].Content = React.createElement(ButtonShowChart_1.ButtonShowChart, { key: "key:" + Chart.Name, style: { marginLeft: "2px" }, cssClassName: this.props.cssClassName, onClick: () => this.props.onShowChart(Chart.Name), size: "xsmall", overrideTooltip: "Show Chart", DisplayMode: "Glyph", AccessLevel: this.props.AccessLevel });
