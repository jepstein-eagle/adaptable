...
class AlertsPanel extends React.Component {
    ...
    render() {
                ...
                React.createElement("div", null,
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        ...
                        React.createElement(react_bootstrap_1.InputGroup.Button, null,
                            React.createElement(ButtonPreviewDelete_1.ButtonPreviewDelete, { cssClassName: this.props.cssClassName, onClick: () => this.props.onClearAlert(index), overrideTooltip: "Clear Alert", bsStyle: "default", DisplayMode: "Glyph", size: "xsmall", overrideDisableButton: false, style: { float: 'left' } })))),
                React.createElement("div", null,
        ...
        let clearAllButton = React.createElement(ButtonClear_1.ButtonClear, { cssClassName: this.props.cssClassName + " pull-right ", onClick: () => this.props.onClearAllAlerts(), bsStyle: "default", style: { margin: "5px" }, size: "xsmall", overrideText: "Clear All", DisplayMode: "Text", hideToolTip: true });
