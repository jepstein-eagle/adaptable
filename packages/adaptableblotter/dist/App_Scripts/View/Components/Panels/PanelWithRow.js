...
class PanelWithRow extends React.Component {
    render() {
        ...
        let header = React.createElement(react_bootstrap_1.Row, { style: { display: "flex", alignItems: "center", fontSize: "small", padding: '2px' } }, headerItems);
        return React.createElement("div", { className: cssClassName },
            React.createElement(react_bootstrap_1.Panel, { header: header, bsSize: "small", className: "ab_no_padding_no_margin ab_small-padding-panel-header", bsStyle: this.props.bsStyle }, this.props.children));
    }
}
