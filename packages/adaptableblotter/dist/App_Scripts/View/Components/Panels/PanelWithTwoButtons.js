    ...
    render() {
        ...
        let header = React.createElement(AdaptableBlotterForm_1.AdaptableBlotterForm, { inline: true },
            React.createElement(react_bootstrap_1.Row, { style: { display: "flex", alignItems: "center" } },
                React.createElement(react_bootstrap_1.Col, { xs: 5 }, this.props.headerText),
                React.createElement(react_bootstrap_1.Col, { xs: 5 }, this.props.secondButton && React.cloneElement(this.props.secondButton, { style: { float: 'right' } })),
                React.createElement(react_bootstrap_1.Col, { xs: 2 }, this.props.firstButton && React.cloneElement(this.props.firstButton, { style: { float: 'right' } }))));
