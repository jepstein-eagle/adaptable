...
class PanelWithImageThreeButtons extends React.Component {
    render() {
        ...
        let header = React.createElement(react_bootstrap_1.Row, { style: { display: "flex", alignItems: "center" } },
        ...
        return React.createElement(react_bootstrap_1.Panel, { header: header, className: className, style: this.props.style, bsStyle: this.props.bsStyle }, this.props.children);
    }
}
