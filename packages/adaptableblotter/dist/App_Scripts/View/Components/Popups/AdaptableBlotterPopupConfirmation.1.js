...
class AdaptableBlotterPopupConfirmationOld extends React.Component {
    constructor(props) {
        super(props);
    }
    render() {
        let title = this.props.ShowCommentBox ?
...
exports.AdaptableBlotterPopupConfirmationOld = AdaptableBlotterPopupConfirmationOld;
