    ...
    render() {
        ...
        var activeFilters = this.props.ColumnFilters.map((columnFilter, index) => {
            return React.createElement("tr", { key: index },
                ...
                React.createElement("td", { colSpan: 2 }, ExpressionHelper_1.ExpressionHelper.ConvertExpressionToString(columnFilter.Filter, this.props.Columns, false)),
                React.createElement("td", null,
                    React.createElement("span", null,
                        ...
                        ' ',
                        React.createElement(ButtonClear_1.ButtonClear, { cssClassName: this.props.cssClassName, onClick: () => this.props.onClear(columnFilter), overrideTooltip: "Clear Column Filter", bsStyle: StyleConstants.DANGER_BSSTYLE, DisplayMode: "Glyph", size: "xs", overrideDisableButton: columnFilter == null, AccessLevel: this.props.AccessLevel }))));
        });
        var header = React.createElement("thead", null,
            React.createElement("tr", null,
                ...
                React.createElement("th", { style: { minWidth: "70px" } })));
