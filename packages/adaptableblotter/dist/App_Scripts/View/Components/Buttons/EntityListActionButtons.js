...
class EntityListActionButtons extends React.Component {
    render() {
        return React.createElement(react_bootstrap_1.ButtonToolbar, { className: this.props.cssClassName + StyleConstants.BUTTON_TOOLBAR, bsSize: "small", style: { margin: "0px", padding: "0px" } },
            this.props.showEdit &&
                React.createElement(ButtonEdit_1.ButtonEdit, { onClick: () => this.props.editClick(), cssClassName: this.props.cssClassName, style: { marginLeft: "0px", marginTop: "2px", marginBottom: "2px", marginRight: "2px" }, overrideDisableButton: this.props.overrideDisableEdit, ConfigEntity: this.props.ConfigEntity, overrideTooltip: this.props.overrideTooltipEdit, DisplayMode: "Glyph", size: "small" }),
            this.props.showDelete &&
                React.createElement(ButtonDelete_1.ButtonDelete, { cssClassName: this.props.cssClassName, style: { marginLeft: "1px", marginTop: "2px", marginBottom: "2px", marginRight: "1px" }, overrideDisableButton: this.props.overrideDisableDelete, ConfigEntity: this.props.ConfigEntity, overrideTooltip: this.props.overrideTooltipDelete, DisplayMode: "Glyph", ConfirmAction: this.props.ConfirmDeleteAction, ConfirmationMsg: "Are you sure you want to delete this " + this.props.EntityName + "?", ConfirmationTitle: "Delete " + this.props.EntityName, size: "small" }),
            this.props.showShare &&
                React.createElement(ButtonShare_1.ButtonShare, { onClick: () => this.props.shareClick(), cssClassName: this.props.cssClassName, style: { marginLeft: "2px", marginTop: "2px", marginBottom: "2px", marginRight: "0px" }, overrideDisableButton: this.props.overrideDisableShare, ConfigEntity: this.props.ConfigEntity, overrideTooltip: this.props.overrideTooltipShare, DisplayMode: "Glyph", size: "small" }));
    }
}
