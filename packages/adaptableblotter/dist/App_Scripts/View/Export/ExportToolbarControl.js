...
class ExportToolbarControlComponent extends React.Component {
    render() {
        ...
        return React.createElement(PanelDashboard_1.PanelDashboard, { cssClassName: cssClassName, useDefaultPanelStyle: this.props.UseSingleColourForButtons, headerText: StrategyConstants.ExportStrategyName, glyphicon: StrategyConstants.ExportGlyph, onClose: () => this.props.onClose(StrategyConstants.ExportStrategyId), onConfigure: () => this.props.onConfigure() }, content);
    }
