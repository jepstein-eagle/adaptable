...
class UserFilterEntityRow extends React.Component {
    render() {
        ...
        colItems[3].Content = React.createElement(EntityListActionButtons_1.EntityListActionButtons, { cssClassName: this.props.cssClassName, editClick: () => this.props.onEdit(this.props.Index, userFilter), shareClick: () => this.props.onShare(), showShare: this.props.TeamSharingActivated, overrideDisableEdit: false, ConfirmDeleteAction: this.props.onDeleteConfirm, EntityType: StrategyConstants.UserFilterStrategyName });
