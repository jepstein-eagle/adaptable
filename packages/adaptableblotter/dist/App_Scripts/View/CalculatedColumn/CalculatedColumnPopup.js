        ...
        return React.createElement("div", { className: cssClassName },
            React.createElement(PanelWithButton_1.PanelWithButton, { cssClassName: cssClassName, headerText: StrategyNames.CalculatedColumnStrategyName, className: "ab_main_popup", infoBody: infoBody, button: newButton, bsStyle: "primary", glyphicon: StrategyGlyphs.CalculatedColumnGlyph },
                ...
                this.state.EditedAdaptableBlotterObject &&
                    React.createElement(CalculatedColumnWizard_1.CalculatedColumnWizard, { cssClassName: cssWizardClassName, EditedAdaptableBlotterObject: this.state.EditedAdaptableBlotterObject, ConfigEntities: this.props.CalculatedColumns, Columns: this.props.Columns, ModalContainer: this.props.ModalContainer, BlotterOptions: this.props.BlotterOptions, BlotterApi: this.props.BlotterApi, UserFilters: this.props.UserFilters, SystemFilters: this.props.SystemFilters, GetErrorMessage: () => this.props.CalculatedColumnErrorMessage, IsExpressionValid: (expression) => this.props.IsExpressionValid(expression), getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, WizardStartIndex: this.state.WizardStartIndex, onCloseWizard: () => this.onCloseWizard(), onFinishWizard: () => this.onFinishWizard(), canFinishWizard: () => this.canFinishWizard() })));
    }
    onNew() {
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        onShare: (entity) => dispatch(TeamSharingRedux.TeamSharingShare(entity, StrategyIds.CalculatedColumnStrategyId))
    };
}
