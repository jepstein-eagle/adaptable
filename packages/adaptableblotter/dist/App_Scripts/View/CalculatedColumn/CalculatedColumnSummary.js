    ...
    render() {
        ...
        return React.createElement("div", null,
            ...
            this.state.EditedAdaptableBlotterObject &&
                React.createElement(CalculatedColumnWizard_1.CalculatedColumnWizard, { cssClassName: cssWizardClassName, EditedAdaptableBlotterObject: this.state.EditedAdaptableBlotterObject, ConfigEntities: this.props.CalculatedColumns, Columns: this.props.Columns, BlotterOptions: this.props.BlotterOptions, BlotterApi: this.props.BlotterApi, ModalContainer: this.props.ModalContainer, UserFilters: this.props.UserFilters, SystemFilters: this.props.SystemFilters, GetErrorMessage: () => this.props.CalculatedColumnErrorMessage, IsExpressionValid: (expression) => this.props.IsExpressionValid(expression), getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, WizardStartIndex: this.state.WizardStartIndex, onCloseWizard: () => this.onCloseWizard(), onFinishWizard: () => this.onFinishWizard(), canFinishWizard: () => this.canFinishWizard() }));
    }
