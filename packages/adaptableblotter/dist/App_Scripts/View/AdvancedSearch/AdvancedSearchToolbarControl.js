    ...
    render() {
        ...
        let content = React.createElement("span", null,
            React.createElement(react_bootstrap_1.InputGroup, null,
                React.createElement(react_bootstrap_1.DropdownButton, { disabled: availableSearches.length == 0, style: { minWidth: "120px" }, className: cssClassName, bsSize: this.props.DashboardSize, bsStyle: "default", title: currentSearchName, id: "advancedSearch", componentClass: react_bootstrap_1.InputGroup.Button }, availableSearches),
                currentSearchName != selectSearchString &&
                    React.createElement(react_bootstrap_1.InputGroup.Button, null,
                        React.createElement(ButtonClear_1.ButtonClear, { bsStyle: "default", cssClassName: cssClassName, onClick: () => this.onSelectedSearchChanged(""), size: this.props.DashboardSize, overrideTooltip: "Clear Search", overrideDisableButton: currentSearchName == selectSearchString, DisplayMode: "Glyph", AccessLevel: this.props.AccessLevel, showDefaultStyle: this.props.UseSingleColourForButtons }))),
            React.createElement("span", { className: this.props.AccessLevel == Enums_1.AccessLevel.ReadOnly ? GeneralConstants.READ_ONLY_STYLE : "" },
                React.createElement(ButtonEdit_1.ButtonEdit, { style: { marginLeft: "5px" }, onClick: () => this.props.onEditAdvancedSearch(), cssClassName: cssClassName, size: this.props.DashboardSize, overrideTooltip: "Edit Current Advanced Search", overrideDisableButton: currentSearchName == selectSearchString, DisplayMode: "Glyph", AccessLevel: this.props.AccessLevel, showDefaultStyle: this.props.UseSingleColourForButtons }),
                React.createElement(ButtonNew_1.ButtonNew, { style: { marginLeft: "2px" }, cssClassName: cssClassName, onClick: () => this.props.onNewAdvancedSearch(), size: this.props.DashboardSize, overrideTooltip: "Create New Advanced Search", DisplayMode: "Glyph", AccessLevel: this.props.AccessLevel, showDefaultStyle: this.props.UseSingleColourForButtons }),
                React.createElement(ButtonDelete_1.ButtonDelete, { style: { marginLeft: "2px" }, cssClassName: cssClassName, size: this.props.DashboardSize, overrideTooltip: "Delete Advanced Search", overrideDisableButton: currentSearchName == selectSearchString, DisplayMode: "Glyph", ConfirmAction: AdvancedSearchRedux.AdvancedSearchDelete(savedSearch), ConfirmationMsg: "Are you sure you want to delete '" + !savedSearch ? "" : savedSearch.Name + "'?", ConfirmationTitle: "Delete Advanced Search", AccessLevel: this.props.AccessLevel, showDefaultStyle: this.props.UseSingleColourForButtons })));
