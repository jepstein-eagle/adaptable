...
class AdvancedSearchWizard extends React.Component {
    render() {
        ...
        return React.createElement("div", { className: this.props.cssClassName },
            React.createElement(AdaptableWizard_1.AdaptableWizard, { FriendlyName: StrategyNames.AdvancedSearchStrategyName, StepNames: stepNames, ModalContainer: this.props.ModalContainer, cssClassName: this.props.cssClassName, Steps: [
                    React.createElement(AdvancedSearchExpressionWizard_1.AdvancedSearchExpressionWizard, { Columns: this.props.Columns, cssClassName: this.props.cssClassName, StepName: stepNames[0], UserFilters: this.props.UserFilters, SystemFilters: this.props.SystemFilters, getColumnValueDisplayValuePairDistinctList: this.props.getColumnValueDisplayValuePairDistinctList, BlotterOptions: this.props.BlotterOptions, BlotterApi: this.props.BlotterApi }),
