...
class AdvancedSearchEntityRow extends React.Component {
    render() {
        ...
        colItems[2].Content = ExpressionHelper_1.ExpressionHelper.ConvertExpressionToString(advancedSearch.Expression, this.props.Columns);
        let buttons = React.createElement(EntityListActionButtons_1.EntityListActionButtons, { cssClassName: this.props.cssClassName, ConfirmDeleteAction: this.props.onDeleteConfirm, showShare: this.props.TeamSharingActivated, editClick: () => this.props.onEdit(this.props.Index, advancedSearch), shareClick: () => this.props.onShare(), overrideDisableEdit: null, ConfigEntity: advancedSearch, EntityName: StrategyIds.AdvancedSearchStrategyName });
