...
class AdvancedSearchEntityRow extends React.Component {
    render() {
        ...
        let buttons = React.createElement(EntityListActionButtons_1.EntityListActionButtons, { cssClassName: this.props.cssClassName, ConfirmDeleteAction: this.props.onDeleteConfirm, showShare: this.props.TeamSharingActivated, editClick: () => this.props.onEdit(this.props.Index, advancedSearch), shareClick: () => this.props.onShare(), overrideDisableEdit: null, EntityName: StrategyIds.AdvancedSearchStrategyName });
