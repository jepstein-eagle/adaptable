...
export class ReminderSummaryWizard extends React.Component<ReminderSummaryWizardProps, {}> implements AdaptableWizardStep {
    ...
    render(): any {
        ...
        let summaryPage = <WizardSummaryPage cssClassName={cssClassName} KeyValuePairs={keyValuePairs} header={StrategyConstants.ReminderStrategyName} />
