...
export class ReminderScheduleWizard extends React.Component<ReminderScheduleWizardProps, ReminderScheduleWizardState> implements AdaptableWizardStep {
    ...
    private onDayChecked(event: React.FormEvent<any>) {
        ...
        this.setState({ DaysOfWeek: daysOfWeek } as ReminderScheduleWizardState, () => this.props.UpdateGoBackState())
    }

    private onOneOffDateChanged = (event: React.FormEvent<any>) => {
        let e = event.target as HTMLInputElement;
        this.setState({ OneOffDate: e.value } as ReminderScheduleWizardState, () => this.props.UpdateGoBackState())
    }

    private onRecurringDateChanged(event: React.FormEvent<any>) {
        let e = event.target as HTMLInputElement;

        this.setState({ IsRecurringDate: (e.value == "recurring") } as ReminderScheduleWizardState, () => this.props.UpdateGoBackState())
    }

    private onHourChanged(event: React.FormEvent<any>) {
        let e = event.target as HTMLInputElement;
        this.setState({ Hour: Number(e.value) } as ReminderScheduleWizardState, () => this.props.UpdateGoBackState())
    }
