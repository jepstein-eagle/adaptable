          ...
          <span>
            {this.state.IsChartSettingsVisible == false && (
              <span>
                <Row>
                  <Col xs={12}>
                    <div className="pull-right">{openChartSettingsButton}</div>
                  </Col>
                </Row>
              </span>
            )}
            {this.state.IsChartSettingsVisible ? (
              <Row>
                <Table>
                  <tbody>
                    <tr>
                      <td>{this.props.ChartData.Data != null && chartElement}</td>
                            ...
                            {this.state.IsGeneralMinimised == false && (
                              <div>
                                <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                  <Row>
                                    <Col xs={6}>
                                      <HelpBlock>Chart Type</HelpBlock>
                                    </Col>
                                    <Col xs={6}>
                                      <FormControl
                                        bsSize={'small'}
                                ...
                                <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                  <Row>
                                    <Col xs={6}>
                                      <HelpBlock>Marker Type</HelpBlock>
                                    </Col>
                                    <Col xs={6}>
                                      <FormControl
                                        bsSize={'small'}
                                ...
                                {this.state.ChartProperties.CategoryChartType ==
                                  ...
                                  <div>
                                    <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                      <Row>
                                        <Col xs={6}>
                                          <HelpBlock>Column Gap</HelpBlock>
                                        </Col>
                                        <Col xs={6}>
                                          <FormControl
                                    ...
                                    <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                      <Row>
                                        <Col xs={6}>
                                          <HelpBlock>Column Overlap</HelpBlock>
                                        </Col>
                                        <Col xs={6}>
                                          <FormControl
                                ...
                                <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                  <Row>
                                    <Col xs={12}>
                                      ...
                                      <HelpBlock>
                                        <Checkbox
                                          onChange={e => this.onYAxisVisibilityOptionChanged(e)}
                                          checked={
                                ...
                                {this.state.ChartProperties.YAxisLabelVisibility ==
                                  ...
                                  <div>
                                    <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                      <Row>
                                        <Col xs={12}>
                                          <HelpBlock>
                                            <Checkbox
                                              onChange={e => this.onYAxisInvertedChanged(e)}
                                    ...
                                    <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                      <Row>
                                        <Col xs={6}>
                                          <HelpBlock>Axis Location</HelpBlock>
                                        </Col>
                                        <Col xs={6}>
                                          <FormControl
                                            bsSize={'small'}
                                    ...
                                    <AdaptableBlotterForm horizontal style={{ marginTop: '0px' }}>
                                      <Row>
                                        <Col xs={6}>
                                          <HelpBlock>Labels Scale</HelpBlock>
                                        </Col>
                                        <Col xs={6}>
                                          <FormControl
                                            bsSize={'small'}
                                      ...
                                      <HelpBlock>
                                        <Row>
                                          <Col xs={6}>
                                            <Checkbox
                                              onChange={e =>
                                                this.onSetYAxisMinValueOptionChanged(e)
                                              }
                                      ...
                                      <HelpBlock>
                                        <Row>
                                          <Col xs={6}>
                                            <Checkbox
                                              onChange={e =>
                                                this.onSetYAxisMaxValueOptionChanged(e)
                                              }
              ...
              <div>{this.props.ChartData.Data != null && chartElement}</div>
            )}
          </span>
        </div>
      </span>
