...
import { IChartDefinition, ICategoryChartDefinition, IChartProperties, IPieChartDefinition } from "../../Utilities/Interface/BlotterObjects/Charting/IChartDefinition";
