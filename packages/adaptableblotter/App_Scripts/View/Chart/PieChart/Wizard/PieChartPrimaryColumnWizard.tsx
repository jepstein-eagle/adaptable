...
import { ICategoryChartDefinition, IPieChartDefinition } from "../../../../Utilities/Interface/BlotterObjects/Charting/IChartDefinition";
...
export class PieChartPrimaryColumnWizard extends React.Component<PieChartPrimaryColumnWizardProps, PieChartPrimaryColumnWizardState> implements AdaptableWizardStep {
                ...
                <AdaptableBlotterForm horizontal>
                    ...
                    <FormGroup controlId="primaryColumn">
                        <Row>
                            <Col xs={1} />
                            <Col xs={10}>
                                <HelpBlock>Select a Primary Column for the Pie Chart.<br /></HelpBlock>
                            </Col>
                            <Col xs={1} />
                        </Row>
                        <Row>
                            <Col xs={4} componentClass={ControlLabel}>Primary Column: </Col>
                            <Col xs={6}>
                                <ColumnSelector cssClassName={cssClassName} SelectedColumnIds={[this.state.PrimaryColumnId]}
    ...
    private onPrimaryColumnChanged(columns: IColumn[]) {
        ...
        } as PieChartPrimaryColumnWizardState, () => this.props.UpdateGoBackState())
    }
