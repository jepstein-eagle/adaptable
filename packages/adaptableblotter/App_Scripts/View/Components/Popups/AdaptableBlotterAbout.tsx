...
export class AdaptableBlotterAbout extends React.Component<AdaptableBlotterAboutProps, AboutBlotterState> {
    ...
    render() {
        ...
        let showBaseOptionsButton =
            this.state.IsBaseOptionsMinimised ?
                this.createMaximiseButton("Base", () => {
                    this.setState({ IsBaseOptionsMinimised: false, IsContainerOptionsMinimised: true, IsAuditOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showContainerOptionsButton =
            this.state.IsContainerOptionsMinimised ?
                this.createMaximiseButton("Container", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsContainerOptionsMinimised: false, IsAuditOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showAuditOptionsButton =
            this.state.IsAuditOptionsMinimised ?
                this.createMaximiseButton("Audit", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsAuditOptionsMinimised: false, IsContainerOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showConfigServerOptionsButton =
            this.state.IsConfigServerOptionsMinimised ?
                this.createMaximiseButton("Config Server", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsAuditOptionsMinimised: true, IsContainerOptionsMinimised: true, IsConfigServerOptionsMinimised: false, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showQueryOptionsButton =
            this.state.IsQueryOptionsMinimised ?
                this.createMaximiseButton("Query", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsAuditOptionsMinimised: true, IsContainerOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: false, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showLayoutOptionsButton =
            this.state.IsLayoutOptionsMinimised ?
                this.createMaximiseButton("Layout", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsAuditOptionsMinimised: true, IsContainerOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: false, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showFilterOptionsButton =
            this.state.IsFilterOptionsMinimised ?
                this.createMaximiseButton("Filter", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsAuditOptionsMinimised: true, IsContainerOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: false, IsGeneralOptionsMinimised: true } as AboutBlotterState)
                })
                :
        ...
        let showGeneralOptionsButton =
            this.state.IsGeneralOptionsMinimised ?
                this.createMaximiseButton("General", () => {
                    this.setState({ IsBaseOptionsMinimised: true, IsAuditOptionsMinimised: true, IsContainerOptionsMinimised: true, IsConfigServerOptionsMinimised: true, IsQueryOptionsMinimised: true, IsLayoutOptionsMinimised: true, IsFilterOptionsMinimised: true, IsGeneralOptionsMinimised: false } as AboutBlotterState)
                })
                :
        ...
        return <Modal show={this.props.showAbout} onHide={this.props.onClose} className={this.state.cssClassName + StyleConstants.BASE}
            ...
            <div className={this.state.cssClassName + StyleConstants.MODAL_BASE} >
                <Modal.Body className={this.state.cssClassName + StyleConstants.MODAL_BODY}>
                    ...
                    <div className={this.state.cssClassName}>
                        <PanelWithImage cssClassName={this.state.cssClassName} header={"About"} bsStyle="primary" glyphicon={"info-sign"}>

                            <Row style={{ marginBottom: '10px' }}>
                                <Col xs={12} >
                                    <Radio inline value="GridProperties" checked={this.state.ShowGridProperties == true} onChange={(e) => this.onShowGridPropertiesChanged(e)}>Grid Properties</Radio>
                                    <Radio inline value="BlotterOptions" checked={this.state.ShowGridProperties == false} onChange={(e) => this.onShowGridPropertiesChanged(e)}>Blotter Options</Radio>
                                </Col>
                            </Row>
                            ...
                            {this.state.ShowGridProperties ?
                                ...
                                <div>
                                    <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={gridPropertiesColItems} items={gridProperties} />
                                </div>
                                ...
                                <div>
                                    ...
                                    <PanelWithButton bsSize={"xs"} headerText={"Base Options"} cssClassName={this.state.cssClassName} button={showBaseOptionsButton}>
                                        {this.state.IsBaseOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={baseBlotterOptions} />
                                        }
                                    </PanelWithButton>

                                    <PanelWithButton bsSize={"xs"} headerText={"Container Options"} cssClassName={this.state.cssClassName} button={showContainerOptionsButton}>
                                        {this.state.IsContainerOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={containerBlotterOptions} />
                                        }
                                    </PanelWithButton>
                                    <PanelWithButton bsSize={"xs"} headerText={"Audit Options"} cssClassName={this.state.cssClassName} button={showAuditOptionsButton}>
                                        {this.state.IsAuditOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={auditBlotterOptions} />
                                        }
                                    </PanelWithButton>
                                    <PanelWithButton bsSize={"xs"} headerText={"Config Server Options"} cssClassName={this.state.cssClassName} button={showConfigServerOptionsButton}>
                                        {this.state.IsConfigServerOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={configServerBlotterOptions} />
                                        }
                                    </PanelWithButton>
                                    <PanelWithButton bsSize={"xs"} headerText={"Query Options"} cssClassName={this.state.cssClassName} button={showQueryOptionsButton}>
                                        {this.state.IsQueryOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={queryBlotterOptions} />
                                        }
                                    </PanelWithButton>
                                    <PanelWithButton bsSize={"xs"} headerText={"Layout Options"} cssClassName={this.state.cssClassName} button={showLayoutOptionsButton}>
                                        {this.state.IsLayoutOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={layoutBlotterOptions} />
                                        }
                                    </PanelWithButton>
                                    <PanelWithButton bsSize={"xs"} headerText={"Filter Options"} cssClassName={this.state.cssClassName} button={showFilterOptionsButton}>
                                        {this.state.IsFilterOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={filterBlotterOptions} />
                                        }
                                    </PanelWithButton>
                                    <PanelWithButton bsSize={"xs"} headerText={"General Options"} cssClassName={this.state.cssClassName} button={showGeneralOptionsButton}>
                                        {this.state.IsGeneralOptionsMinimised == false &&
                                            <AdaptableObjectCollection cssClassName={this.state.cssClassName} colItems={blotterOptionsColItems} items={generalBlotterOptions} />
                                        }
                                    </PanelWithButton>
                ...
                <Modal.Footer className={this.state.cssClassName + StyleConstants.MODAL_FOOTER}>
                    <Button className={this.state.cssClassName + StyleConstants.MODAL_FOOTER + StyleConstants.CLOSE_BUTTON} onClick={() => this.props.onClose()}>Close</Button>
                </Modal.Footer>
            </div>
        </Modal>
    }
    ...
    private CreateGridInfo(colItems: IColItem[]): IColItem[][] {
        ...
        if (this.props.showAbout) {
            let calcColumns: string[] = this.props.AdaptableBlotter.api.calculatedColumnApi.getAllCalculatedColumn().map(c => c.ColumnId)
            let columns: IColumn[] = this.props.AdaptableBlotter.api.gridApi.getColumns();
            let columnFilterDescription: string = ColumnFilterHelper.getColumnFiltersDescription(this.props.AdaptableBlotter.api.columnFilterApi.getAllColumnFilter(), columns, this.props.AdaptableBlotter)
