...
export class LayoutEntityRow extends React.Component<LayoutEntityRowProps<LayoutEntityRow>, {}> {
    ...
    render(): any {
        ...
        colItems[0].Content = <EntityRowItem Content={<Radio style={{ padding: "0px", margin: "0px" }} onChange={() => this.props.onSelect(layout)} checked={this.props.IsCurrentLayout} />} />
        colItems[1].Content = <EntityRowItem Content={layout.Name} />;
        colItems[2].Content = <EntityRowItem Content={LayoutHelper.getLayoutDescription(layout, this.props.Columns)} />;
