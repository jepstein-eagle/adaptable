...
export class ActiveFiltersPanel extends React.Component<ActiveFiltersPanelProps, {}> {
    ...
    private createRow(colItems: IColItem[], columnFilter: IColumnFilter, cssClassName: string): any {
        ...
        rowColItems[0].Content = ColumnHelper.getFriendlyNameFromColumnId(columnFilter.ColumnId, this.props.Columns)
        rowColItems[1].Content = ExpressionHelper.ConvertExpressionToString(columnFilter.Filter, this.props.Columns, false)
        rowColItems[2].Content = <span style={{ alignContent: "right" }}>
        ...
        let rowElement = <AdaptableObjectRow cssClassName={cssClassName} key={columnFilter.ColumnId} colItems={rowColItems} />
        return rowElement
    }
