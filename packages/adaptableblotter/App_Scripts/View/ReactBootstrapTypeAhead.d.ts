declare module 'react-bootstrap-typeahead' {
  export var Typeahead: React.ClassicComponentClass<TypeaheadProps<any>>;
  export default Typeahead;
  //export var AsyncTypeahead: React.ClassicComponentClass<AsyncTypeaheadProps<any>>
  ...
  /* not susing this for now */
  interface AsyncTypeaheadProps<T> extends TypeaheadProps<T> {
