...
import { ICalculatedColumn, IColumnFilter, ICellValidationRule, IGridSort, ILayout, IFreeTextColumn, IPercentCellRenderer } from '../../Core/Api/Interface/IAdaptableBlotterObjects';
...
export class AdaptableBlotter implements IAdaptableBlotter {
    ...
    constructor(blotterOptions: IAdaptableBlotterOptions, renderGrid: boolean = true) {
        ...
        this.Strategies.set(StrategyConstants.ConditionalStyleStrategyId, new ConditionalStyleKendoStrategy(this))
