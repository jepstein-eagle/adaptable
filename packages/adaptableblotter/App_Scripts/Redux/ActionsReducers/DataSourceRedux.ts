...
export const DataSourceAddUpdate = (
  index: number,
  DataSource: IDataSource
): DataSourceAddUpdateAction => ({
  type: DATASOURCE_ADD_UPDATE,
  index,
  DataSource,
});

export const DataSourceChangeName = (
  DataSource: IDataSource,
  Name: string
): DataSourceChangeNameAction => ({
  type: DATASOURCE_CHANGE_NAME,
  DataSource,
  Name,
});

export const DataSourceChangeDescription = (
  DataSource: IDataSource,
  Description: String
): DataSourceChangeDescriptionAction => ({
