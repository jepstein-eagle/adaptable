...
export const PercentBarChangeMinimumValue = (
  PercentBar: IPercentBar,
  MinimumValue: number
): PercentBarChangeMinimumValueAction => ({
  type: PERCENT_BAR_CHANGE_MINIMUM_VALUE,
  PercentBar,
  MinimumValue,
});

export const PercentBarChangeMaximumValue = (
  PercentBar: IPercentBar,
  MaximumValue: number
): PercentBarChangeMaximumValueAction => ({
  type: PERCENT_BAR_CHANGE_MAXIMUM_VALUE,
  PercentBar,
  MaximumValue,
});

export const PercentBarChangePositiveColor = (
  PercentBar: IPercentBar,
  PositiveColor: string
): PercentBarChangePositiveColorAction => ({
  type: PERCENT_BAR_CHANGE_POSITIVE_COLOR,
  PercentBar,
  PositiveColor,
});

export const PercentBarChangeNegativeColor = (
  PercentBar: IPercentBar,
  NegativeColor: string
): PercentBarChangeNegativeColorAction => ({
