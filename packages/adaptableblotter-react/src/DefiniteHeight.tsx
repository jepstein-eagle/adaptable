...
const DefiniteHeight = ({ childProps, ...props }: { childProps?: React.HTMLProps<HTMLElement> } & React.HTMLProps<HTMLElement>) => {
  ...
  return <div {...props} style={style} ref={domRef}>
    <div {...childProps} ref={childDOMRef} style={{
