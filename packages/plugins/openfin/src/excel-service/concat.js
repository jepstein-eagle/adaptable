  ...
  /******/ [
        ...
        invokeRemoteCall(topic, functionName, data, callback) {
          ...
          Object.assign(message, {
            ...
            target: {
              ...
              workbookName:
                invoker.workbookName ||
                (invoker.workbook && invoker.workbook.workbookName) ||
                args.workbookName ||
                args.workbook,
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      class ExcelService extends RpcDispatcher_1.RpcDispatcher {
        constructor() {
          ...
          this.processExcelServiceResult = result =>
            __awaiter(this, void 0, void 0, function*() {
        ...
        subscribeToServiceMessages() {
          return Promise.all([
            ...
            new Promise(resolve =>
              fin.desktop.InterApplicationBus.subscribe(
                excelServiceUuid,
                'excelServiceCallResult',
                this.processExcelServiceResult,
                resolve
              )
            ),
          ]);
        ...
        monitorDisconnect() {
          return new Promise((resolve, reject) => {
            ...
            var onDisconnect;
            excelServiceConnection.addEventListener(
              'disconnected',
              (onDisconnect = () => {
        ...
        configureDefaultApplication() {
          return __awaiter(this, void 0, void 0, function*() {
            var defaultAppObjUuid =
              this.defaultApplicationObj && this.defaultApplicationObj.connectionUuid;
            ...
            var connectedAppUuid = Object.keys(this.applications).find(
              appUuid => this.applications[appUuid].connected
            );
            if (connectedAppUuid) {
        ...
        processExcelConnectedEvent(data) {
          return __awaiter(this, void 0, void 0, function*() {
            var applicationInstance =
              this.applications[data.uuid] || new ExcelApplication_1.ExcelApplication(data.uuid);
        ...
        processGetExcelInstancesResult(connectionUuids) {
          return __awaiter(this, void 0, void 0, function*() {
            ...
            this.applications = {};
            yield Promise.all(
              connectionUuids.map(connectionUuid =>
                __awaiter(this, void 0, void 0, function*() {
                  ...
                  if (existingInstance === undefined) {
                    ...
                    yield this.processExcelServiceEvent({
                      event: 'excelConnected',
                      uuid: connectionUuid,
                    });
                  } else {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      class ExcelApplication extends RpcDispatcher_1.RpcDispatcher {
        constructor(connectionUuid) {
          ...
          this.processExcelEvent = (data, uuid) => {
            ...
            switch (eventType) {
              ...
              case 'sheetRenamed':
                ...
                if (worksheet) {
                  ...
                  workbook.dispatchEvent(eventType, {
                    worksheet: worksheet.toObject(),
                    oldWorksheetName: oldWorksheetName,
                  });
                }
                break;
              ...
              case 'sheetAdded':
                var newWorksheet =
                  worksheet || new ExcelWorksheet_1.ExcelWorksheet(data.sheetName, workbook);
              ...
              case 'workbookOpened':
                var newWorkbook =
                  workbook || new ExcelWorkbook_1.ExcelWorkbook(this, data.workbookName);
              ...
              case 'workbookSaved':
                ...
                if (workbook) {
                  ...
                  this.dispatchEvent(eventType, {
                    workbook: workbook.toObject(),
                    oldWorkbookName: oldWorkbookName,
                  });
                }
                break;
            ...
            switch (result.action) {
              case 'getWorkbooks':
                ...
                workbookNames.forEach(workbookName => {
                  this.workbooks[workbookName] =
                    oldworkbooks[workbookName] ||
                    new ExcelWorkbook_1.ExcelWorkbook(this, workbookName);
                });
                callbackData = workbookNames.map(workbookName =>
                  this.workbooks[workbookName].toObject()
                );
                break;
              case 'getWorksheets':
                ...
                worksheetNames.forEach(worksheetName => {
                  workbook.worksheets[worksheetName] =
                    oldworksheets[worksheetName] ||
                    new ExcelWorksheet_1.ExcelWorksheet(worksheetName, workbook);
                });
                callbackData = worksheetNames.map(worksheetName =>
                  workbook.worksheets[worksheetName].toObject()
                );
                break;
              case 'addWorkbook':
              case 'openWorkbook':
                ...
                var newWorkbook =
                  this.workbooks[newWorkbookName] ||
        ...
        monitorDisconnect() {
          return new Promise((resolve, reject) => {
            var excelApplicationConnection = fin.desktop.ExternalApplication.wrap(
              this.connectionUuid
            );
            var onDisconnect;
            excelApplicationConnection.addEventListener(
              'disconnected',
              (onDisconnect = () => {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      class ExcelWorksheet extends RpcDispatcher_1.RpcDispatcher {
        ...
        getCells(start, offsetWidth, offsetHeight, callback) {
          return this.invokeExcelCall(
            'getCells',
            { start: start, offsetWidth: offsetWidth, offsetHeight: offsetHeight },
            callback
          );
        }
        ...
        getColumn(start, offsetHeight, callback) {
          return this.invokeExcelCall(
            'getCellsColumn',
            { start: start, offsetHeight: offsetHeight },
            callback
          );
        }
        activate() {
        ...
        addButton(name, caption, cellAddress) {
          return this.invokeExcelCall('addButton', {
            address: cellAddress,
            buttonName: name,
        ...
        formatRange(rangeCode, format, callback) {
          return this.invokeExcelCall(
            'formatRange',
            { rangeCode: rangeCode, format: format },
            callback
          );
        }
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      Object.defineProperty(window.fin.desktop, 'Excel', {
        get() {
          return ExcelApi_1.ExcelService.instance.defaultApplicationObj;
        },
      });
