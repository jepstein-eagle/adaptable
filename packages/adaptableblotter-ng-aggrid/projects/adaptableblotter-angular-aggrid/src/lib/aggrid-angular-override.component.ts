...
export class AgGridOverrideComponent implements AfterViewInit {
  // not intended for user to interact with. so putting _ in so if user gets reference
  // to this object, they kind'a know it's not part of the agreed interface
  public _nativeElement: any;
  public _initialised = false;
  public _destroyed = false;

  public gridParams: GridParams;

  // in order to ensure firing of gridReady is deterministic
  public _fullyReady: Promise<boolean> = new Promise<boolean>(resolve => {
    resolve(true);
  });
  ...
  constructor(
    ...
    public angularFrameworkOverrides: AngularFrameworkOverrides,
    public frameworkComponentWrapper: AngularFrameworkComponentWrapper,
  ...
  private checkForDeprecatedEvents() {
    _.iterateObject<any>(Events, (key, eventName) => {
      if (
        ...
        (<EventEmitter<any>>(this as any)[eventName]).observers.length > 0
      ) {
  ...
  @Output() public columnEverythingChanged: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public newColumnsLoaded: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public columnPivotModeChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public columnRowGroupChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public expandOrCollapseAll: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public columnPivotChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public gridColumnsChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public columnValueChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public columnGroupOpened: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public columnResized: EventEmitter<any> = new EventEmitter<any>();
  @Output() public displayedColumnsChanged: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public virtualColumnsChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public pinnedRowDataChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public rangeSelectionChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public chartRangeSelectionChanged: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public chartOptionsChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public toolPanelVisibleChanged: EventEmitter<
    any
  > = new EventEmitter<any>();
  ...
  @Output() public cellDoubleClicked: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public cellValueChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public virtualRowRemoved: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public rowClicked: EventEmitter<any> = new EventEmitter<any>();
  @Output() public rowDoubleClicked: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public firstDataRendered: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public rowEditingStarted: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public rowEditingStopped: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public cellEditingStarted: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public cellEditingStopped: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public bodyScroll: EventEmitter<any> = new EventEmitter<any>();
  @Output() public animationQueueEmpty: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public heightScaleChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public paginationChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public componentStateChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public bodyHeightChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  @Output() public displayedColumnsWidthChanged: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public scrollVisibilityChanged: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public columnHoverChanged: EventEmitter<any> = new EventEmitter<
    any
  >();
  ...
  @Output() public columnRowGroupChangeRequest: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public columnPivotChangeRequest: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public columnValueChangeRequest: EventEmitter<
    any
  > = new EventEmitter<any>();
  @Output() public columnAggFuncChangeRequest: EventEmitter<
    any
  > = new EventEmitter<any>();
  // @END@
}
