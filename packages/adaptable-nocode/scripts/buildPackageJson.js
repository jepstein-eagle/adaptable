...
const abBlotterPackagePath = resolve(process.cwd(), '../adaptable/package.json');
...
packageJSON.peerDependencies = {
  ...packageJSON.peerDependencies,
  '@adaptabletools/adaptable': `>=${topLevelPackageJSON.version}`,
};
...
fs.writeFile(
  resolve(process.cwd(), './dist/adaptable', 'package.json'),
  JSON.stringify({
