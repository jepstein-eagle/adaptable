  ...
  useTickingDataagGrid(
    ...
    if (gridOptions != null && gridOptions.api != null) {
      ...
      setInterval(() => {
        ...
        const notional = this.generateRandomInt(1, 5); // trade.notional + this.generateRandomInt(-100, 100); // this.getRandomItem(examplesHelper.getNotionals());
