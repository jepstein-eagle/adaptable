...
export class ReactHarnessHelper {
  ...
  getTradeSchema(): any {
      ...
      schema.push({ headerName: "Notional", field: "notional", editable: true, filter: 'text', cellRenderer: this.notionalCellRenderer, enableRowGroup: true, type: ["abColDefNumber"], enableValue: true });
