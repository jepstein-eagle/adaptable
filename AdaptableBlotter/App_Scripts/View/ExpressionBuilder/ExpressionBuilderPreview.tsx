                        ...
                        <div className="adaptable_blotter_div_like_button" onClick={() => this.props.onSelectedColumnChange(columnId)} style={{ cursor: 'pointer' }}>
                            <AdaptableBlotterForm inline>
                                ...
                                <OverlayTrigger overlay={<Tooltip id="tooltipDelete">Delete</Tooltip>}>
                                    <Button bsSize="xsmall" bsStyle="danger" style={{ float: 'right' }} onClick={(e) => { this.props.DeleteColumnValue(columnId, y); if (!this.props.ShowPanel) { e.stopPropagation(); } } }><Glyphicon glyph="trash" /></Button>
                                </OverlayTrigger>
                        ...
                        return <ListGroupItem key={ne.Uid}>
                            <div className="adaptable_blotter_div_like_button" onClick={() => this.props.onSelectedColumnChange(columnId)} style={{ cursor: 'pointer' }}>
                                <AdaptableBlotterForm inline>
                                    {ne.FriendlyName}
                                    <OverlayTrigger overlay={<Tooltip id="tooltipDelete">Delete</Tooltip>}>
                                        <Button bsSize="xsmall" bsStyle="danger" style={{ float: 'right' }} onClick={(e) => { this.props.DeleteUserFilterExpression(columnId, index); if (!this.props.ShowPanel) { e.stopPropagation(); } } }><Glyphicon glyph="trash" /></Button>
                                    </OverlayTrigger>
                                </AdaptableBlotterForm>
                            </div>
                        </ListGroupItem>
                            ...
                            return <ListGroupItem key={columnId + index} bsStyle="danger" >
                                <div className="adaptable_blotter_div_like_button" onClick={() => this.props.onSelectedColumnChange(columnId)} style={{ cursor: 'pointer' }}>
                                    <AdaptableBlotterForm inline>
                                        ...
                                        <OverlayTrigger overlay={<Tooltip id="tooltipDelete">Delete</Tooltip>}>
                                            <Button bsSize="xsmall" bsStyle="danger" style={{ float: 'right' }} onClick={(e) => { this.props.DeleteRange(columnId, index); if (!this.props.ShowPanel) { e.stopPropagation(); } } }><Glyphicon glyph="trash" /></Button>
                                        </OverlayTrigger>
                                    </AdaptableBlotterForm>
                                </div>
                            </ListGroupItem>
