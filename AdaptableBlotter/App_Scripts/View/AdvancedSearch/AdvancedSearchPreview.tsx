...
interface AdvancedSearchPreviewProps extends React.ClassAttributes<AdvancedSearchPreview> {
...
export class AdvancedSearchPreview extends React.Component<AdvancedSearchPreviewProps, {}> {
    componentWillReceiveProps(nextProps: AdvancedSearchPreviewProps, nextContext: any) {
    ...
    render() {
        ...
        return <div style={previewItemsStyle}>
            {previewLists}
        </div>
