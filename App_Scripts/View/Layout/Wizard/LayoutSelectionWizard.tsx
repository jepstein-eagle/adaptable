...
export class LayoutSelectionWizard extends React.Component<LayoutSelectionWizardProps, LayoutSelectionWizardState> implements AdaptableWizardStep {
            ...
            <Panel header="Select Source for Layout" bsStyle="primary">
                <AdaptableBlotterForm inline>
                    ...
                    <Col xs={12} className="large_margin_style">
                        ...
                        <Radio inline value="Existing" checked={this.state.LayoutSource == LayoutSource.Existing} onChange={(e) => this.onScopeSelectChanged(e)}>Use current Grid Setup</Radio>
    ...
    private onScopeSelectChanged(event: React.FormEvent<any>) {
        ...
        if (e.value == "Existing") {
            this.setState({ LayoutSource: LayoutSource.Existing } as LayoutSelectionWizardState, () => this.props.UpdateGoBackState())
        } else {
            this.setState({ LayoutSource: LayoutSource.New, ColumnId: "" } as LayoutSelectionWizardState, () => this.props.UpdateGoBackState())
        }
    }
