...
import { PopoverType, CellValidationMode } from '../../../Core/Enums';
...
export class CellValidationActionWizard extends React.Component<CellValidationActionWizardProps, CellValidationSettingsWizardState> implements AdaptableWizardStep {
    constructor(props: CellValidationActionWizardProps) {
        super(props)
        this.state = {
            CellValidationMode: this.props.Data.CellValidationMode as CellValidationMode,
        }
    }
    ...
    private onCellValidationModeChanged(event: React.FormEvent<any>) {
        ...
        this.setState({ CellValidationMode: e.value as CellValidationMode} as CellValidationSettingsWizardState, () => this.props.UpdateGoBackState())
    }
